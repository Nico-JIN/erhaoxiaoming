...
`);
  ...
  const processImage = (file: File) => {
    ...
    // Use URL.createObjectURL to create a short blob URL
    ...
    <div className="h-[calc(100vh-80px)] flex flex-col bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between shrink-0 z-20 relative shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-1.5 bg-slate-900 text-white rounded-lg text-sm font-medium hover:bg-slate-800 transition-all shadow-lg shadow-slate-200"
          >
            <Save size={16} />
            {t('editor.publish')}
          </button>
      ...
      <div className="flex-1 flex overflow-hidden relative bg-white">
        ...
        <div className={`flex flex-col border-r border-slate-200 bg-white transition-all duration-300 relative z-10 ${showPreview ? 'w-1/2' : 'w-full max-w-4xl mx-auto border-x'}`}>
          ...
          {/* Text Area Container */}
          <div className="flex-1 relative w-full h-full bg-white group">
             <textarea
              ref={textareaRef}
              value={content}
              ...
              className="absolute inset-0 w-full h-full p-8 resize-none outline-none font-mono text-base leading-relaxed text-slate-900 bg-white custom-scrollbar z-10"
              style={{ color: '#0f172a', backgroundColor: '#ffffff' }}
              placeholder="Start typing... (Drag & Drop images here)"
              spellCheck={false}
            />
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 border-t border-slate-100 bg-slate-50 flex justify-end gap-3">
              ...
              <button 
                ...
                className="px-6 py-2.5 bg-indigo-600 text-white rounded-xl font-bold shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition-colors"
              >
